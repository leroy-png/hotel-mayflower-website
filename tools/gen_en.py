  ...
  <section class="section section--tint">
    <div class="container split">
      <div class="reveal">
        ...
        <p style="font-size:.9rem;color:var(--faint)">Staying with us? Our <a href="/en/guide/">guest guide</a> lists restaurants, walking routes and day trips, all starting at our front door. Tip: see <a href="https://www.visitleiden.nl/en" rel="noopener">visitleiden.nl</a> for exhibitions and events during your stay. Attractions listed here are recommendations for your visit; opening hours and programmes are set by the venues themselves.</p>
      </div>
